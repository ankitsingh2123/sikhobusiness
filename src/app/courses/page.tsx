  ...
  return (
    <div className="min-h-screen bg-[#07080F] text-white px-4 sm:px-6 md:px-12 py-10 md:py-16 pb-28 font-sans overflow-hidden relative">
      ...
      <div className="max-w-[1400px] mx-auto min-w-0 relative z-10">
        ...
        <div className="mb-12 md:mb-24 flex flex-col items-center text-center animate-fade-in-up relative mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 mb-12 lg:h-[400px]">
          ...
          <Link href="/search?category=Business" className="md:col-span-8 group relative rounded-[32px] overflow-hidden flex flex-col justify-end p-8 sm:p-12 hover:-translate-y-2 transition-transform duration-500 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
            <div className="absolute inset-0 bg-[#0D0E1A]/80 z-0" />
            <img 
              src="/api/assets?name=business" 
          ...
          <div className="md:col-span-4 flex flex-col gap-4 md:gap-6">
            <Link href="/search?category=Editing" className="flex-1 group relative rounded-[32px] overflow-hidden flex flex-col justify-end p-6 sm:p-8 hover:-translate-y-2 transition-transform duration-500 shadow-[0_20px_50px_rgba(0,0,0,0.5)] min-h-[200px]">
              <div className="absolute inset-0 bg-[#4C1D95]/40 z-0" />
              <img 
                src="/api/assets?name=creative" 
            ...
            <Link href="/search?category=Finance" className="flex-1 group relative rounded-[32px] overflow-hidden flex flex-col justify-end p-6 sm:p-8 hover:-translate-y-2 transition-transform duration-500 shadow-[0_20px_50px_rgba(0,0,0,0.5)] min-h-[200px]">
              <div className="absolute inset-0 bg-[#065F46]/40 z-0" />
              <img 
                src="/api/assets?name=finance" 
                alt="Finance & Wealth" 
                className="absolute inset-0 w-full h-full object-cover opacity-50 mix-blend-screen group-hover:scale-105 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#07080F] to-transparent z-10" />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4">
          {categories.filter(c => !['Business', 'Editing', 'Finance', 'Share Market', 'AI'].includes(c.name)).map((cat, idx) => (
            <Link 
              ...
              key={cat.name} 
              className="group relative flex flex-col items-center justify-center p-4 sm:p-6 rounded-[24px] bg-[#0D0E1A]/40 backdrop-blur-md border border-white/5 hover:bg-[#0D0E1A]/80 hover:border-[#8B5CF6]/30 transition-all duration-300 hover:-translate-y-1 overflow-hidden"
            >
              <div 
