    ...
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center p-3 sm:p-6 md:p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-[1100px] bg-[#111]/80 backdrop-blur-2xl rounded-none border border-white/10 overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.8)] flex flex-col md:flex-row relative z-10 mb-16 md:mb-0">
        ...
        <div className="relative w-full md:w-[45%] lg:w-[45%] p-4 md:p-12 lg:p-16 flex flex-col justify-center md:justify-between min-h-[80px] md:min-h-[600px] overflow-hidden group">
          ...
          {/* Bottom Text (Hidden on mobile for compact layout) */}
          <div className="relative z-10 hidden md:block">
            <div className="hidden md:inline-flex items-center gap-1.5 px-3 py-1 rounded-none bg-white/10 border border-white/20 text-white/80 text-[10px] sm:text-xs font-semibold uppercase tracking-widest mb-4 backdrop-blur-md">
              <span className="w-1.5 h-1.5 rounded-none bg-[#3CE36A] animate-pulse" />
              Welcome Back
            </div>
        ...
        <div className="w-full md:w-[55%] lg:w-[55%] p-5 sm:p-10 md:p-14 lg:p-20 flex flex-col justify-center bg-[#161616]/50 relative">
          ...
          <div className="max-w-[400px] mx-auto w-full relative z-10">
            <div className="mb-5 md:mb-10 text-center md:text-left">
              <h2 className="text-xl md:text-3xl font-black text-white mb-1 md:mb-2 tracking-tight">Log In</h2>
              <p className="text-[#888] text-xs md:text-base">Enter your details to continue learning.</p>
            </div>

            <LoginForm />

            <div className="mt-5 md:mt-8 pt-5 md:pt-8 border-t border-white/5 text-center">
              <p className="text-xs md:text-[14px] text-[#888]">
