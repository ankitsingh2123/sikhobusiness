  ...
  return (
    <div className="w-full">
      ...
      <button 
        ...
        className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg border border-white/10 bg-[#1A1A1A] hover:bg-white/[0.05] transition-colors text-white font-medium text-sm mb-8 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {isGoogleLoading ? (
